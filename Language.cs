...
namespace IceChat
{
    ...
    public class IceChatLanguage
    {
        public IceChatLanguage()
        {
            ...
            // about dialog
            aboutText = "IceChat 9 is an IRC (Internet Relay Chat) program. It is used to connect to an unlimited amount of IRC Servers simultaneously and chat in channels with other IRC users.  Version 9 is a complete rewrite of the program , using a tabbed interface, and written in C#. It is also now Open Source.";
        }
