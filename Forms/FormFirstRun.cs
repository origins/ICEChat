...
namespace IceChat
{
    ...
    {
        private string[] Default_Servers = new string[] { "ice.syntaxnode.net", "irc.quakenet.org", "irc.freenode.net" };
        ...
        private string[] Query_Popup = new string[] { "Info:/userinfo $1", "Whois:/whois $nick", "-", "Ignore:/ignore $1 1 | /close $1", "-", ".Ping:/ctcp $1 ping", ".Time:/ctcp $1 time", ".Version:/ctcp $1 version", "DCC", ".Send:/dcc send $1", ".Chat:/dcc chat $1" };
        ...
        private void MakeDefaultFiles()
        {
            ...
            if (comboData.Text.Length > 0)
            {
                ...
                if (comboData.Text.ToLower() == "ice.syntaxnode.net")
                {
                    s.AutoJoinChannels = new string[] { "#icechat" };
                    s.AutoJoinEnable = true;
                }
                else if (comboData.Text.ToLower() == "irc.quakenet.org")
                {
                    s.AutoJoinChannels = new string[] { "#icechat" };
                    s.AutoJoinEnable = true;
                }
